...
export default function Home1xbet() {
  ...
  const goToTest = (classe: string, serie?: string) => {
    ...
    const target = `/1xbet/test/questions/${niveauToUrlPart(classe)}/${serieSlug}`;
    navigate(target);
  };
  ...
  return (
    ...
    >
      <div className="min-h-screen flex flex-col items-center justify-center px-6 py-8 text-white z-20">
        <h1 className="text-3xl font-extrabold mb-6 text-white">🎓 BIENVENUE SUR CODE</h1>
        <p className="mb-6 text-lg text-white/90">
          Choisissez votre classe pour commencer le test en 1XBET :
        </p>
