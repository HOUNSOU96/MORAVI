...
export default function Homechine() {
  ...
  const goToTest = (classe: string, serie?: string) => {
    ...
    const target = `/chine/test/questions/${niveauToUrlPart(classe)}/${serieSlug}`;
    navigate(target);
  };
    ...
    >
      <div className="min-h-screen flex flex-col items-center justify-center px-6 py-8 text-white z-20">
        ...
        <p className="mb-6 text-lg text-white/90">
          Choisissez votre classe pour commencer le test de la langue CHINOISE :
        </p>
        ...
        {showSeries && (
          <div className="mt-6 text-center">
            <p className="mb-4 font-semibold text-white">
              Tu es en {selectedLevel} ? Choisissez votre série :
            </p>
        ...
        {selectedSerie && subSeriesMap[selectedSerie] && (
          <div className="mt-6 text-center">
            <p className="mb-4 font-semibold text-white">
              Tu as choisi la série {selectedSerie}. Sélectionne ta sous-série :
            </p>
            <div className="flex flex-wrap justify-center gap-3">
