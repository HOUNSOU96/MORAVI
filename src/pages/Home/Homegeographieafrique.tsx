...
export default function Homegeographieafrique() {
  ...
  const goToTest = (classe: string, serie?: string) => {
    ...
    const target = `/geographieafrique/test/questions/${niveauToUrlPart(classe)}/${serieSlug}`;
    navigate(target);
  };
    ...
    >
      <div className="min-h-screen flex flex-col items-center justify-center px-6 py-8 text-white z-20">
        ...
        <p className="mb-6 text-lg text-white/90">
          Choisissez votre classe pour commencer le test dans la GÉOGRAPHIE DE L' AFRIQUE :
        </p>
        ...
        {showSeries && (
          <div className="mt-6 text-center">
            <p className="mb-4 font-semibold text-white">
              Vous êtes en {selectedLevel} ? Choisissez ta série :
            </p>
