// 📁 Matiere.tsx (PCT avec icônes adaptées)
import React from "react";
import { useNavigate } from "react-router-dom";
import { motion } from "framer-motion";
import { useAuth } from "../../hooks/useAuth";
import { GiAtom, GiChemicalDrop } from "react-icons/gi"; // Physique & Chimie
import { MdOutlineEngineering } from "react-icons/md";   // Technologie
...
const Matiere: React.FC = () => {
  ...
  const pctOptions = [
    { name: "physique", label: "Physique", icon: GiAtom, color: "text-blue-600" },
    { name: "chimie", label: "Chimie", icon: GiChemicalDrop, color: "text-red-600" },
    { name: "technologie", label: "Technologie", icon: MdOutlineEngineering, color: "text-green-600" },
  ];
  ...
  const handleChoice = (pct: string) => {
    navigate(`/home/home${pct}`);
  };
